define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            $.ajax({
                url: 'nowvoicetype/getVoiceTypeMap',
                type: 'GET',
                dataType: 'json',
                success: function (response) {
                    ...
                    columns = [
                        [
                            ...
                            // {field: 'voice_type', searchList: voiceType,title: __('Voice_type')},
                            {field: 'voice_type', title: __('Voice_type'), searchList: response, formatter: Table.api.formatter.normal },
