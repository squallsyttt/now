define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'nowfriend/index' + location.search,
                    add_url: 'nowfriend/add',
                    edit_url: 'nowfriend/edit',
                    del_url: 'nowfriend/del',
                    multi_url: 'nowfriend/multi',
                    import_url: 'nowfriend/import',
                    table: 'nowfriend',
                }
            });
